<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Sample1.aspx.vb" Inherits="Samples_UpdatePanelExample_Sample1" %>
...
<head>
    ...
    <title>FusionCharts - Update Panel Example</title>
...
<body>
    ...
    <div id="wrapper">
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            <Scripts>
                <asp:ScriptReference Path="JS/updatepanelhook.fusioncharts.js" />
            </Scripts>
        </asp:ScriptManager>
        <div id="header">
    ...
    <div id="footer">
        <ul>
            <li><a href="http://www.fusioncharts.com/dev/"><span>&laquo; Documentation</span></a></li>
        </ul>
    </div>
    </form>
</body>
